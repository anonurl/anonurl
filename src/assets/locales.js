export const en = {
    ...
    home: { 
        ...
        button: "Shorten",
        invalid: "Invalid URL address, you've used \"http://\" or \"https://\"?",
    ...
    redirect: {
        willbe: "You'll be redirected to: ",
        agree: "Agree",
        cancel: "Cancel"
    },
    report: {
        title: "Do you have any suspicious URL or comment? Send a message to us!",
        placeholder: "Enter the message",
        button: "Send report",
        empty: "You can't send a empty message to us!",
        message: "Thanks for your report, it helps us improve the security!"
    },
    track: {
        title: "Track any ID ou URL",
        placeholder: "Enter the ID or URL",
        button: "Search",
        empty: "Enter a valid ID ou URL!",
        creation: "Creation date: ",
        notfound: "ID/URL not founded on database."
    }
}
...
export const pt = {
    ...
    home: {
        ...
        button: "Encurtar",
        invalid: "Endereço inválido, você utilizou \"http://\" ou \"https://\"?",
